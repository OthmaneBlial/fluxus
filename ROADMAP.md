...
- [x] 5.2 Artefacts et notes de version — `CHANGELOG.md`, notes, procédure et `release:check` présents ; le candidat `0.1.1` a produit un tarball de 11 735 octets et SHA-256 `1c72bc41cc336b8da9e0f0602397d46a358cd2c1602a2bf49b3a3cd2f62a81ad`, avec dry-run npm et installation isolée réussis.
- [x] 5.3 Publication et vérification externes — `@othmaneblial/fluxus@0.1.1` publié puis téléchargé depuis npm avec SHA-256 identique ; `v0.1.1`, GitHub Release et assets pointent vers `5f65010` ; le workflow Pages tag-gated a réussi (`35447224823`) et l’URL publique a été testée par ajout, complétion, filtre et pause de l’observateur.
