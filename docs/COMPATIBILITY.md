...
No release cadence or support lifetime is promised. The release notes name the currently verified published version. The [security policy](../SECURITY.md) distinguishes the current branch from published versions.
